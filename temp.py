...
def get_period_performance(data, periods=[360], stat='Close', offset=0, weight=1):
    ...
    for i, period in enumerate(periods):
        ...
        for ticker in tickers:
            ...
            df.at[ticker, period] = ((last_close - first_close) / first_close) * 100
            ...
            if offset > 0 and i == len(periods)-1:
                ...
                df.at[ticker, f"Next_{offset}"] = ((next_last_close - next_first_close) / next_first_close) * 100
        
    return df
get_period_performance(data, data_set_intervals[-1])
...
if __name__ == '__main__':
    ...
    for days_back in data_set_intervals:
        ...
        offset = 0
        df_perf = get_period_performance(data, days_back)
        print(df_perf)
        #offset = days_back[-1]
