...
#stocklist = si.tickers_other()
total_stocks = len(stocklist)
n = -1
for stock in stocklist:
    n += 1
    time.sleep(.1)
    print ("\npulling {} with index {} of {}".format(stock, n, total_stocks))
    ...
    try:
        ...
        if(condition_1 and condition_2 and condition_3 and condition_4 and condition_5 and condition_6 and condition_7 and condition_8):
            ...
            print(condition_1, condition_2, condition_3, condition_4, condition_5, condition_6, condition_7, condition_8)
